...
SHARED_MESSAGING_SLOT_POLICY = (
    ...
    "- If the active clarification chain already knows the recipient and the current turn provides the message body, execute now instead of asking for the recipient again.\n"
    "- If the active clarification chain already knows the recipient and current turn uses a pronoun like her, him, them, or this person, resolve that pronoun to the known recipient instead of reopening recipient clarification.\n"
    "- Pronouns from current turn may shape the message body, but they must never become the final contact payload when the recipient is already known.\n"
