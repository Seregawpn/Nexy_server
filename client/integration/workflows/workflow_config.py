...
class WorkflowsConfig:
    ...
    def from_dict(cls, config_dict: dict[str, Any]) -> "WorkflowsConfig":
        """Создание конфигурации из словаря"""
        listening_config = ListeningWorkflowConfig.from_dict(config_dict.get("listening", {}))
        processing_config = ProcessingWorkflowConfig.from_dict(config_dict.get("processing", {}))
    ...
    def default(cls) -> "WorkflowsConfig":
        ...
        return cls(listening=ListeningWorkflowConfig(), processing=ProcessingWorkflowConfig())
