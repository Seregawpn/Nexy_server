...
REGISTRY: dict[str, Callable[[Snapshot, Any, dict[str, Any] | None], bool]] = {}
...
def perm_screen(s: Snapshot, expected: str, extra: dict[str, Any] | None) -> bool:
...
def perm_accessibility(s: Snapshot, expected: str, extra: dict[str, Any] | None) -> bool:
...
def permissions_all_ready(s: Snapshot, expected: bool, extra: dict[str, Any] | None) -> bool:
...
def device_idle_predicate(s: Snapshot, expected: bool, extra: dict[str, Any] | None) -> bool:
...
def device_busy_predicate(s: Snapshot, expected: bool, extra: dict[str, Any] | None) -> bool:
...
def network_online_predicate(s: Snapshot, expected: bool, extra: dict[str, Any] | None) -> bool:
...
def network_offline_predicate(s: Snapshot, expected: bool, extra: dict[str, Any] | None) -> bool:
...
def permission_restart_predicate(_s: Snapshot, expected: Any, extra: dict[str, Any] | None) -> bool:
