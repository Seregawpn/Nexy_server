...
SLO_THRESHOLDS = {
    ...
    "permission_restart_success_rate": {
        "min": 0.98,
        "description": "Permission restart success rate (≥ 98%)",
    },
    "permission_restart_latency_ms": {
        "p95_max": 15000,
        "description": "Permission restart latency (p95 ≤ 15s)",
    },
}
...
def extract_percentile_from_logs(
    log_content: str, metric_name: str, percentile: int = 95
) -> float | None:
