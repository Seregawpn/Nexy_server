...
def extract_startup_order_from_code() -> list:
    ...
    """
    coordinator_path = (
        Path(__file__).parent.parent / "integration" / "core" / "simple_module_coordinator.py"
    )
...
class TestInitOrder:
    ...
    def test_tray_immediately_after_instance_manager(self):
        ...
        assert "instance_manager" in startup_order, "instance_manager must be in startup_order"
        assert "tray" in startup_order, "tray must be in startup_order"
    ...
    def test_permission_restart_after_first_run_permissions(self):
        ...
        assert "permission_restart" in startup_order, "permission_restart must be in startup_order"
    ...
    def test_startup_order_contains_all_required(self):
        ...
        for integration in required:
            assert integration in startup_order, f"{integration} must be in startup_order"
