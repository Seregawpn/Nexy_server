#!/usr/bin/env python3
"""
Скрипт для проверки разрешений доступа к базе данных Messages

Проверяет:
- Доступность файла базы данных
- Возможность чтения базы данных
...
def check_permissions():
    ...
    if accessible:
        ...
        print("   2. Перейдите в Конфиденциальность и безопасность")
        print("   3. Найдите 'Полный доступ к диску'")
        print("   4. Добавьте Terminal/Cursor в список")
    ...
    if conn:
        ...
        print("=" * 70)
        print()
        print("🎉 Разрешения настроены правильно!")
        print("   Теперь вы можете использовать все функции MCP сервера:")
