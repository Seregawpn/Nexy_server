...
class ScreenshotCapture:
    ...
    async def capture_screenshot(self, config: ScreenshotConfig | None = None) -> ScreenshotResult:
        ...
        try:
            ...
            result = await loop.run_in_executor(None, self._capture_sync, capture_config)
            ...
            return ScreenshotResult(success=False, error=f"Ошибка захвата скриншота: {e}")
    ...
    def _capture_sync(self, config: ScreenshotConfig) -> ScreenshotResult:
        ...
        try:
            ...
            return ScreenshotResult(success=False, error=f"Ошибка синхронного захвата: {e}")

    async def capture_region(
        self, region: tuple[int, int, int, int], config: ScreenshotConfig | None = None
    ) -> ScreenshotResult:
        """
        ...
        try:
            ...
            result = await loop.run_in_executor(
                None, self._capture_region_sync, region, capture_config
            )
            ...
            return ScreenshotResult(
                success=False, error="Таймаут захвата области", capture_time=capture_config.timeout
            )
        except Exception as e:
            logger.error(f"❌ Ошибка захвата области: {e}")
            return ScreenshotResult(success=False, error=f"Ошибка захвата области: {e}")
    ...
    def _capture_region_sync(
        ...
        try:
            ...
            return ScreenshotResult(success=False, error=f"Ошибка синхронного захвата области: {e}")
