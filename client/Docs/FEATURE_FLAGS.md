...
4. **Проверка интегрирована** в `scripts/pre_build_gate.sh` и выполняется автоматически перед мерджем
...
- `scripts/pre_build_gate.sh` — включает проверку флагов в общий quality gate
