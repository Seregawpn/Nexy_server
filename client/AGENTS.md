...
- Для Codex и Antigravity обязательно добавлять блок **"Информация об изменениях"**:
  - что изменено (кратко, по пунктам);
  - список файлов;
  - причина/цель изменений;
  - проверка (что выполнено для валидации).
- Блок **"Информация об изменениях"** размещать в отчетном документе сразу после раздела `## Verification`.
- Если изменений в коде/документах нет, обязательно явно писать: **"Изменения не вносились"**.
