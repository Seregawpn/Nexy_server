...
AudioDeviceIntegrationDiagnostic = _load_diagnostic_class(
    "diagnostic_audio_device_integration", "AudioDeviceIntegrationDiagnostic"
)
AudioDeviceManagerDiagnostic = _load_diagnostic_class(
    "diagnostic_audio_device_manager", "AudioDeviceManagerDiagnostic"
)
AutostartManagerIntegrationDiagnostic = _load_diagnostic_class(
    "diagnostic_autostart_manager_integration", "AutostartManagerIntegrationDiagnostic"
)
GrpcClientDiagnostic = _load_diagnostic_class("diagnostic_grpc_client", "GrpcClientDiagnostic")
GrpcClientIntegrationDiagnostic = _load_diagnostic_class(
    "diagnostic_grpc_client_integration", "GrpcClientIntegrationDiagnostic"
)
HardwareIdIntegrationDiagnostic = _load_diagnostic_class(
    "diagnostic_hardware_id_integration", "HardwareIdIntegrationDiagnostic"
)
InputProcessingDiagnostic = _load_diagnostic_class(
    "diagnostic_input_processing", "InputProcessingDiagnostic"
)
InputProcessingIntegrationDiagnostic = _load_diagnostic_class(
    "diagnostic_input_processing_integration", "InputProcessingIntegrationDiagnostic"
)
InstanceManagerIntegrationDiagnostic = _load_diagnostic_class(
    "diagnostic_instance_manager_integration", "InstanceManagerIntegrationDiagnostic"
)
InterruptManagementIntegrationDiagnostic = _load_diagnostic_class(
    "diagnostic_interrupt_management_integration", "InterruptManagementIntegrationDiagnostic"
)
ModeManagementDiagnostic = _load_diagnostic_class(
    "diagnostic_mode_management", "ModeManagementDiagnostic"
)
ModeManagementIntegrationDiagnostic = _load_diagnostic_class(
    "diagnostic_mode_management_integration", "ModeManagementIntegrationDiagnostic"
)
NetworkManagerDiagnostic = _load_diagnostic_class(
    "diagnostic_network_manager", "NetworkManagerDiagnostic"
)
NetworkManagerIntegrationDiagnostic = _load_diagnostic_class(
    "diagnostic_network_manager_integration", "NetworkManagerIntegrationDiagnostic"
)
PermissionsDiagnostic = _load_diagnostic_class("diagnostic_permissions", "PermissionsDiagnostic")
ScreenshotCaptureIntegrationDiagnostic = _load_diagnostic_class(
    "diagnostic_screenshot_capture_integration", "ScreenshotCaptureIntegrationDiagnostic"
)
SignalIntegrationDiagnostic = _load_diagnostic_class(
    "diagnostic_signal_integration", "SignalIntegrationDiagnostic"
)
SpeechPlaybackDiagnostic = _load_diagnostic_class(
    "diagnostic_speech_playback", "SpeechPlaybackDiagnostic"
)
SpeechPlaybackIntegrationDiagnostic = _load_diagnostic_class(
    "diagnostic_speech_playback_integration", "SpeechPlaybackIntegrationDiagnostic"
)
TrayControllerIntegrationDiagnostic = _load_diagnostic_class(
    "diagnostic_tray_controller_integration", "TrayControllerIntegrationDiagnostic"
)
UnifiedConfigDiagnostic = _load_diagnostic_class(
    "diagnostic_unified_config", "UnifiedConfigDiagnostic"
)
UpdaterIntegrationDiagnostic = _load_diagnostic_class(
    "diagnostic_updater_integration", "UpdaterIntegrationDiagnostic"
)
VoiceRecognitionDiagnostic = _load_diagnostic_class(
    "diagnostic_voice_recognition", "VoiceRecognitionDiagnostic"
)
VoiceRecognitionIntegrationDiagnostic = _load_diagnostic_class(
    "diagnostic_voice_recognition_integration", "VoiceRecognitionIntegrationDiagnostic"
)
VoiceOverDuckingIntegrationDiagnostic = _load_diagnostic_class(
    "diagnostic_voiceover_ducking_integration", "VoiceOverDuckingIntegrationDiagnostic"
)
WelcomeMessageIntegrationDiagnostic = _load_diagnostic_class(
    "diagnostic_welcome_message_integration", "WelcomeMessageIntegrationDiagnostic"
)
...
class MasterDiagnostic:
    ...
    async def run_all_diagnostics(self) -> dict[str, Any]:
        ...
        try:
            ...
            ] = await audio_integration_diagnostic.run_diagnostic()
        except Exception as e:
        ...
        try:
            ...
            ] = await grpc_integration_diagnostic.run_diagnostic()
        except Exception as e:
        ...
        try:
            ...
            self.results[
                "mode_management_integration"
            ] = await mode_integration_diagnostic.run_diagnostic()
        except Exception as e:
        ...
        try:
            ...
            ] = await input_integration_diagnostic.run_diagnostic()
        except Exception as e:
        ...
        try:
            ...
            self.results[
                "autostart_manager_integration"
            ] = await autostart_integration_diagnostic.run_diagnostic()
        except Exception as e:
        ...
        try:
            ...
            self.results[
                "hardware_id_integration"
            ] = await hardware_integration_diagnostic.run_diagnostic()
        except Exception as e:
        ...
        try:
            ...
            self.results[
                "instance_manager_integration"
            ] = await instance_integration_diagnostic.run_diagnostic()
        except Exception as e:
        ...
        try:
            ...
            ] = await speech_integration_diagnostic.run_diagnostic()
        except Exception as e:
        ...
        try:
            ...
            ] = await voice_integration_diagnostic.run_diagnostic()
        except Exception as e:
        ...
        try:
            ...
            ] = await tray_integration_diagnostic.run_diagnostic()
        except Exception as e:
        ...
        try:
            ...
            self.results[
                "interrupt_management_integration"
            ] = await interrupt_integration_diagnostic.run_diagnostic()
        except Exception as e:
        ...
        try:
            ...
            ] = await network_integration_diagnostic.run_diagnostic()
        except Exception as e:
        ...
        try:
            ...
            self.results[
                "screenshot_capture_integration"
            ] = await screenshot_integration_diagnostic.run_diagnostic()
        except Exception as e:
        ...
        try:
            ...
            self.results[
                "signal_integration"
            ] = await signal_integration_diagnostic.run_diagnostic()
        except Exception as e:
        ...
        try:
            ...
            self.results[
                "updater_integration"
            ] = await updater_integration_diagnostic.run_diagnostic()
        except Exception as e:
        ...
        try:
            ...
            self.results[
                "voiceover_ducking_integration"
            ] = await voiceover_integration_diagnostic.run_diagnostic()
        except Exception as e:
        ...
        try:
            ...
            ] = await welcome_integration_diagnostic.run_diagnostic()
        except Exception as e:
    ...
    def _generate_summary(self) -> dict[str, Any]:
        ...
        for category, results in self.results.items():
            if isinstance(results, dict) and "total_tests" in results:
                ...
                success_rate = (
                    (category_successful / category_tests * 100) if category_tests > 0 else 0
                )
                status = "✅" if category_failed == 0 else "❌"

                print(
                    f"   {status} {category.upper()}: {category_successful}/{category_tests} ({success_rate:.1f}%)"
                )
