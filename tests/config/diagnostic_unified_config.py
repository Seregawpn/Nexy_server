    ...
    def _test_config_loader(self):
        ...
        try:
            ...
            if audio_config:
                ...
                # Проверяем что приоритеты загружены (audio_config - это словарь)
                if 'input_device_priorities' in audio_config and audio_config['input_device_priorities']:
                ...
                if 'output_device_priorities' in audio_config and audio_config['output_device_priorities']:
