...
cfg = get_config()
allowed = get_allowed_commands_from_config(cfg)

print("browser_use.enabled:", cfg.browser_use.enabled)
print("google_search_enabled:", cfg.features.google_search_enabled)
print("messages.enabled:", cfg.features.messages_enabled)
print("whatsapp.enabled:", cfg.whatsapp.enabled)
print("payment.active:", cfg.subscription.is_active())
...
prompt = build_system_prompt(
    ...
    google_search_enabled=cfg.features.google_search_enabled,
)
