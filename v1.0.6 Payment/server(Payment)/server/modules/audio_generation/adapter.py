    ...
    async def initialize(self, config: dict) -> None:
        ...
        try:
            ...
            if await self._processor.initialize():
                ...
                error_msg = "Не удалось инициализировать AudioProcessor - проверьте логи выше для деталей"
            ...
            logger.debug(f"AudioGenerationAdapter initialization traceback: {error_details}")
            raise
