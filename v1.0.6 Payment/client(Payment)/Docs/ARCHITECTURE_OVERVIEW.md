...
- ✅ **FirstRunPermissionsIntegration** - флаг `~/.Nexy/permissions_first_run_completed.flag` (проверка: `test -f ~/.Nexy/permissions_first_run_completed.flag`)
...
- ⚠️ **Упаковка/деплой** - см. `Docs/packaging/` для инструкций по упаковке
...
- **FirstRunPermissionsIntegration:** Управление разрешениями при первом запуске
  - Флаг: `~/.Nexy/permissions_first_run_completed.flag`
...
### 🖥️ **КЛИЕНТСКИЕ МОДУЛИ (client/modules) - 19 МОДУЛЕЙ**
...
### 🖥️ **КЛИЕНТСКИЕ ИНТЕГРАЦИИ (client/integration/integrations) - 19 ИЗ 19**
