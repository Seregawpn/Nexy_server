...
## Путь к proto-файлу на клиенте

```
/Users/sergiyzasorin/Development/Nexy/client/modules/grpc_client/proto/streaming.proto
```

**Скопируйте этот файл на сервер и используйте его как источник истины!**
