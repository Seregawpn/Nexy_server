...
Для staging/beta использовать соответствующий owner-path:
- `/home/azureuser/voice-assistant-staging/config.env`
...
# staging/beta runtime
bash server/scripts/deploy_server_one_click.sh --tag vX.Y.Z.W --runtime-target staging
```
