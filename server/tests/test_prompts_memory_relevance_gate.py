...
def test_messages_prompt_reuses_known_slot_within_active_clarification_chain():
    ...
    assert "If the current turn starts or replaces the task with an explicitly named recipient, that recipient is already resolved for the new task and asking who the message is for is invalid." in prompt
    ...
    assert "If the current turn starts or replaces the task with an explicitly named recipient, that recipient is already resolved for the new WhatsApp task and asking who the message is for is invalid." in prompt
