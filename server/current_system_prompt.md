...
- ALWAYS perform a **real web search** using the Google Search tool
...
- Do NOT output steps or instructions for Google Search results
...
**Note:** General information queries ("Search for cats", "Who is...", "Price of...") are **Google Search**, NOT Browser.
...
- Do NOT use browser_use for simple informational searches (use Google Search instead).
