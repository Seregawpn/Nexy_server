...
**Канон:** `Docs/MCP_COMMAND_INTEGRATION_PLAN.md` — полный план реализации поддержки action-ответов от ассистента.
...
- `Docs/MCP_COMMAND_INTEGRATION_PLAN.md` — детальный план реализации по фазам
