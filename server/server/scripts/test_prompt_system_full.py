...
def test_prompt_building():
    ...
    if "browser_use" not in prompt_wa:
        logger.info("✅ 'browser_use' correctly ABSENT (disabled)")
    else:
        logger.error("❌ 'browser_use' wrongfully PRESENT")
    ...
    if "browser_use" in prompt_browser:
        logger.info("✅ 'browser_use' found in prompt")
    else:
        logger.error("❌ 'browser_use' NOT found in prompt")
    ...
    if "send_whatsapp_message" not in prompt_browser:
        logger.info("✅ 'send_whatsapp_message' correctly ABSENT")
    else:
        logger.error("❌ 'send_whatsapp_message' wrongfully PRESENT")
