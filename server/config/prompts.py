...
PROMPT_WHATSAPP = (
    ...
    "- Do NOT reuse recipient/content from previous turns unless user explicitly confirms it.\n"
    "- Ask one short clarifying question only if required execution fields are missing in current request (contact and/or message).\n\n"
...
CURRENT_GOAL_USAGE_POLICY = (
    ...
    "- Read Current goal first as the active task anchor.\n"
    "- Current goal is a plain-text summary of the current unfinished executable user task.\n"
    "- Use Current goal only if it is clearly relevant to the current user request.\n"
    ...
    "- Use Short-term memory only to resolve continuity, referential wording, and pronouns.\n"
...
GENERATOR_EXECUTION_POLICY = (
    ...
    "- Reuse known slots from Current goal and short-term memory when they are clearly established.\n"
...
PROMPT_INTENT_CLASSIFIER = (
    ...
    "Use current_goal first and short-term context second when current input is ambiguous or continuation-like.\n\n"
    + CURRENT_GOAL_USAGE_POLICY
    + "\n\n"
    + CATEGORY_GENERAL_DECISION_POLICY
    + "\n\n"
