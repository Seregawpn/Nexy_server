...
PROMPT_MESSAGES = (
    ...
    "- Do NOT reuse contact/message from previous turns unless the user explicitly confirms reusing them now.\n"
...
CATEGORY_RULES_BROWSER = (
    ...
    "- Continue when active browser goal exists and user modifies the same website task with turns like play this instead, sleep music instead, open another one.\n"
    "- Do not choose for factual lookups or for OS-level app open/close actions.\n"
    "- Replace/clear when user cancels browser task or starts a new explicit system_control/messages/google_search task.\n"
)
...
CATEGORY_RULES_GOOGLE_SEARCH = (
    ...
    "- Continue when active search topic exists and user refines the topic or asks for more details.\n"
    "- Do not choose for website interaction steps or desktop app control.\n"
    "- Replace/clear when user cancels the search or starts a different explicit executable task.\n"
)
...
CATEGORY_RULES_SYSTEM_CONTROL = (
    ...
    "- Replace old task when current turn explicitly pivots into app open/close.\n"
)
