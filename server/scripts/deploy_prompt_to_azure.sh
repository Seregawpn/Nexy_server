...
cd /tmp
git clone "$REPO_URL" nexy_repo_temp
cd nexy_repo_temp
...
echo "   2. Проверьте health endpoint: curl -sk https://nexy-prod-sergiy.canadacentral.cloudapp.azure.com/health"
