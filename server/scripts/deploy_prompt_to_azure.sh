...
echo "   🏥 Health Check: https://nexy-server.canadacentral.cloudapp.azure.com/health"
echo "   📋 Status API: https://nexy-server.canadacentral.cloudapp.azure.com/status"
echo ""
log_info "⏳ Следующие шаги:"
echo "   1. Дождитесь завершения GitHub Actions (2-3 минуты)"
echo "   2. Проверьте health endpoint: curl -sk https://nexy-server.canadacentral.cloudapp.azure.com/health"
