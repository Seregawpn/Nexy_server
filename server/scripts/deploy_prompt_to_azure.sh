...
echo "   🏥 Health Check: https://20.151.51.172/health"
echo "   📋 Status API: https://20.151.51.172/status"
echo ""
log_info "⏳ Следующие шаги:"
echo "   1. Дождитесь завершения GitHub Actions (2-3 минуты)"
echo "   2. Проверьте health endpoint: curl -sk https://20.151.51.172/health"
