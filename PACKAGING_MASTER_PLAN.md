...
5. ❌ → ✅ AppleDouble (._*) в PKG вызывали `unsealed contents` — добавлена обязательная очистка Payload перед финальной подписью/нотаризацией
...
- ✅ Контроль extended attributes: PKG пересобирается без AppleDouble файлов с повторной подписью
